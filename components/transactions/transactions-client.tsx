...
export default function TransactionsClient({ initialData }: TransactionsClientProps) {
    ...
    return (
        <div className="h-dvh flex flex-col overflow-hidden bg-background selection:bg-neutral-800">
                ...
                <div className="flex-1 min-h-0 flex flex-col gap-8 overflow-hidden">
                    ...
                    {filteredData.length > 0 ? (
                        <>
                            ...
                            {/* Mobile: card list */}
                            <div className="md:hidden flex-1 min-h-0 overflow-y-auto scrollbar-hide pb-24">
